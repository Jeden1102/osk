...
const NotFoundComponent = () => {
  return (
    <section className="bg-white py-20 dark:bg-gray-900 lg:py-[110px]">
        ...
        <div className="-mx-4 flex flex-wrap items-center">
          ...
          <div className="w-full px-4 md:w-7/12 lg:w-6/12 xl:w-5/12">
            <div>
              ...
              <Link
                href="/"
                className="rounded-md bg-primary px-7 py-3 text-base font-medium text-white transition hover:bg-primary dark:bg-primary dark:hover:bg-primary/80"
              >
                Go To Home
              </Link>
            </div>
